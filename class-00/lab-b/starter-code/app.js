...
//It is the specific instance of the Student object assigned as let joe = new Student('Joe', 'Schmoe', 100);
// 2. What is "this" when joe.scopeArrow() is invoked?
//It is the browser window.
// 3. Explain why "this" is different when an arrow function is used.
//Because the arrow pointer cannot reference instances of objects, so 'this' to the arrow pointer is refering to the current page you are on.
